...
/*
 * $Log: BSlib.h,v $
 * Revision 1.1  2004/10/04 13:24:40  adwan
 * vxstats in the new location with bootinfo support
 *
 * Revision 1.1  2004/08/23 07:22:05  adwan
 * vxstats added for the first time
 *
 * Revision 1.1  2000/09/08 23:54:25  carl
 * 	Added source files for stats, reboot, timestamp
 *
 * Revision 1.1.1.1  1998/04/14  23:55:50  lewis
 * From APS:
 *   += SLAC drivers
 *   += LBL extensions in 3.12.2 form
 *   += "site" stuff (appMakeDir using makeBaseApp RULES and other)
 *
 *   -= LBL drivers
 *   -= save/restore
 *
 * Revision 1.1.1.1  1998/03/31  19:40:29  lewis
 * Start of R3.13 series.
 *
 * Revision 1.1.1.1  1997/12/03  23:36:06  susanna
 * EPICS R3.13.0 beta11 base distribution of July 1997 as taken from
 * the EPICS web site.					Susanna Jacobson
 * 							December 3, 1997
 *
 * Revision 1.2  1995/09/07 21:25:47  jbk
 * Completed first version of vx info server and workstation utility.
