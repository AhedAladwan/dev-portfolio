...
/* Generated from ../O.Common/argusApp.dbd */
...
epicsShareExtern void (*pvar_func_argusRegister)(void);
...
epicsShareExtern void (*pvar_func_NDFileMagickRegister)(void);
...
int argusApp_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "C:/beamline/perforce/Dev/SBS/4_Controls/4_3_Network_Infrastructure/4_3_1_Comms_Common_Services/sw/device_drivers/argusAD";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"argusApp_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    argusApp_registerRecordDeviceDriver(*iocshPpdbbase);
}
